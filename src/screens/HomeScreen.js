...
const HomeScreen = () => {
  ...
  const getWeeklyData = () => {
    ...
    const barColors = weeklyData.map(minutes => minutes === maxMinutes ? '#B38C31' : '#373737');
  ...
  const getMonthlyData = () => {
    ...
    const barColors = monthlyData.map(minutes => minutes === maxMinutes ? '#B38C31' : '#373737');
                  ...
                  <View style={{
                        ...
                        <BarChart
                          ...
                          chartConfig={{
                            ...
                            propsForVerticalLabels: {
                              dx: -dimensions.width * 0.025,
                            },
                            propsForHorizontalLabels: {
                              dx: dimensions.width * 0.01,
                            },
                          }}
                    ...
                    <View style={{
                      ...
                      <Text
                        ...
                        {getWeeklyData().datasets[0].data.every(item => item === 0) ? 'You have not listened to music this week' :
                  ...
                  <View style={{
                    ...
                    <View style={{
                      ...
                      <Text
                        ...
                        {getMonthlyData().datasets[0].data.every(item => item === 0) ? 'You have not listened to music this month' :
